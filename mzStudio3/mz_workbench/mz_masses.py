...
def add_15N(res_dict):
    '''
    
    Added 2022-08-21: N15 labeled base amino acids as nf prefix, for example nfA = 15N labeled alanine.
    ...
    for AA in AAs:
        res_dict['nf' + AA] = copy.copy(res_dict[AA])
        res_dict['nf' + AA]['N'] -= 1
        res_dict['nf' + AA]['N15'] = end[AA]
...
#----------------------------------------------------------------------------------------
#**************************************************Tesing
#pass#print mass_dict
#pass#print fixed_mod_dict
#pass#print var_mod_dict
